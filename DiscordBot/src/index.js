...
// The PHP admin panel can read this heartbeat directly. This avoids depending
// on IIS/PHP being able to make a loopback socket request to Node.
...
function removeHeartbeat() {
  try { if (fs.existsSync(heartbeatFile)) fs.unlinkSync(heartbeatFile); } catch {}
}
writeHeartbeat();
