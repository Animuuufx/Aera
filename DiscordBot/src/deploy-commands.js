...
const commands = [
  ...
  new SlashCommandBuilder()
    .setName('players')
    .setDescription('Show the number of players currently online.'),
  new SlashCommandBuilder()
    .setName('player')
    .setDescription('Look up an Aera player account.')
    .addStringOption(option => option.setName('name').setDescription('Player username or name to search for.').setRequired(true)),
  new SlashCommandBuilder()
    .setName('ping')
    .setDescription('Check the Discord bot latency.'),
  new SlashCommandBuilder()
    .setName('announce')
    .setDescription('Post an Aera announcement in the current channel.')
  ...
  new SlashCommandBuilder()
    .setName('unban')
    .setDescription('Unban a Discord user by ID.')
  ...
  new SlashCommandBuilder()
    .setName('timeout')
    .setDescription('Temporarily timeout a Discord member.')
  ...
  new SlashCommandBuilder()
    .setName('botstatus')
    .setDescription('Show detailed Discord bot status.')
