...
return static function (Router $r): void {
    ...
    $r->get('/', [HomeController::class, 'index']); $r->get('/character', [HomeController::class, 'character']); $r->get('/rankings', [HomeController::class, 'rankings']); $r->get('/play', [HomeController::class, 'play']); $r->get('/news/{slug}', [HomeController::class, 'news']); $r->get('/wiki', [WikiController::class, 'index']); $r->get('/wiki/swf', [WikiController::class, 'gamefile']);
