...
use Aera\Controllers\DownloadController;
use Aera\Controllers\StoreController;
...
return static function (Router $r): void {
    ...
    $r->get('/', [HomeController::class, 'index']); $r->get('/character', [HomeController::class, 'character']); $r->get('/rankings', [HomeController::class, 'rankings']); $r->get('/play', [HomeController::class, 'play']); $r->get('/downloads', [DownloadController::class, 'index']); $r->get('/store', [StoreController::class, 'index']); $r->get('/news/{slug}', [HomeController::class, 'news']); $r->get('/wiki', [WikiController::class, 'index']);
    ...
    $r->get('/api/game/version', [GameApiController::class, 'version']); $r->get('/api/game/clientvars', [GameApiController::class, 'clientvars']); $r->post('/api/game/login', [GameApiController::class, 'login']); $r->post('/api/game/register', [GameApiController::class, 'register']); $r->post('/api/char/bank', [GameApiController::class, 'bank']); $r->post('/api/char/HouseSaveRoom', [GameApiController::class, 'houseSaveRoom']); $r->get('/api/data/booklore', [GameApiController::class, 'bookLore']); $r->get('/api/data/servers', [GameApiController::class, 'servers']); $r->post('/api/data/serversext', [GameApiController::class, 'serversExtended']); $r->get('/api/charpage/fvars', [GameApiController::class, 'charPage']);
    $r->get('/admin', [AdminController::class, 'dashboard']); $r->get('/admin/logs', [AdminController::class, 'logs']); $r->get('/admin/players', [AdminEmulatorController::class, 'players']); $r->get('/admin/data', [AdminDataController::class, 'index']); $r->get('/admin/data/{table}/new', [AdminDataController::class, 'createForm']); $r->post('/admin/data/{table}/new', [AdminDataController::class, 'create']); $r->get('/admin/data/{table}/edit', [AdminDataController::class, 'editForm']); $r->post('/admin/data/{table}/edit', [AdminDataController::class, 'edit']); $r->post('/admin/data/{table}/delete', [AdminDataController::class, 'delete']); $r->get('/admin/data/{table}', [AdminDataController::class, 'table']);
    ...
    $r->get('/admin/downloads', [DownloadController::class, 'admin']); $r->get('/admin/downloads/form', [DownloadController::class, 'form']); $r->post('/admin/downloads/new', [DownloadController::class, 'create']); $r->post('/admin/downloads/{id}/edit', [DownloadController::class, 'edit']); $r->post('/admin/downloads/{id}/delete', [DownloadController::class, 'delete']);
    $r->get('/admin/store', [StoreController::class, 'admin']); $r->get('/admin/store/form', [StoreController::class, 'form']); $r->post('/admin/store/new', [StoreController::class, 'create']); $r->post('/admin/store/{id}/edit', [StoreController::class, 'edit']); $r->post('/admin/store/{id}/delete', [StoreController::class, 'delete']);
