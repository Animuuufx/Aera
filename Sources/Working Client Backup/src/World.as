...
import flash.net.URLLoaderDataFormat;
    ...
    public class World extends MovieClip 
    {
        ...
        // Aera database-driven world entities supplied by moveToArea.
        ...
        // Smooth held-key movement state.
        ...
        private const DASH_STAMINA_COST:Number = 50;
        ...
        public function loaderCallback(e:Event):* {
            ...
            if (l.callBackA != null) {
                ...
                {
                    if (((rootClass != null) && (rootClass.debugMessage != null)))
                    {
                        rootClass.debugMessage(("Loader callback failed: " + callbackError.message));
                    }
                }
            }
            closeLoader(l, true);
        ...
        public function loaderHTTP(e:HTTPStatusEvent):void {
            var l:*;
            var str:String;
            if (((e != null) && (e.status != 0) && (e.status != 200))) {
        ...
        public function loaderErrorHandler(_arg_1:IOErrorEvent):*
        {
            ...
            _local_4 = getLoaderHostByLoaderInfo(_arg_1.currentTarget);
            if (_local_4 == null)
            {
                _local_2 = _arg_1.toString();
                if (_local_2.indexOf("URL: ") > -1)
                {
                    _local_3 = _local_2.substr((_local_2.indexOf("URL: ") + 5));
                    if (_local_3.length > 0)
                    {
                        _local_3 = _local_3.substr(0, (_local_3.length - 1));
                    }
                    _local_4 = getLoaderHostByURL(_local_3);
                }
            }
            if (_local_4 == null)
            {
            ...
            if (((rootClass != null) && (_local_4.loaderData != null)))
            {
                try
                {
                    rootClass.debugMessage(((("Failed to load, Linkage: " + _local_4.loaderData.sES) + ", File: ") + _local_4.loaderData.strFile));
                }
        ...
        public function getLoaderHostByURL(u:String):Object {
            ...
            for (i in loaderManager) {
                if (((loaderManager[i] != null) && (loaderManager[i].url != null) && (String(loaderManager[i].url).length > 0) && (u.indexOf(String(loaderManager[i].url)) > -1))) {
                    return (loaderManager[i]);
                }
            }
            return null;
        ...
        private function loadNextWith(l:Object, loaderData:Object):void {
            ...
            if (((l == null) || (l.ldr == null)))
            {
                return;
            }
            if (((loaderData == null) || (loaderData.strFile == null) || (String(loaderData.strFile).length < 1)))
            {
                l.free = true;
                loadNext(l);
                return;
            ...
            u = new URLRequest(String(loaderData.strFile));
            l.url = u.url;
            l.isOpen = false;
            ...
            catch(loadError:Error)
            {
                if (l.callBackB != null)
                {
                    try
                    {
                        l.callBackB(new IOErrorEvent(IOErrorEvent.IO_ERROR, false, false, loadError.message));
                    }
                    catch(callbackError:Error)
                    {
                    }
        ...
        public function getClass(assetLinkageID:String):Class
        {
            ...
            for (_local_4 in playerDomains) {
                if (((playerDomains[_local_4] != null) && (playerDomains[_local_4].loaderD != null) && (playerDomains[_local_4].loaderD.hasDefinition(assetLinkageID)))) {
        ...
        /**
         * Smooth continuous WASD movement through the normal AvatarMC movement
         * pipeline, including collision and movement network packets.
         */
        public function movePlayerByKeyboard(dx:Number, dy:Number):void
        {
            ...
            // Normalize diagonals so W+D is not faster than W alone.
            dx = (dx / length);
            dy = (dy / length);
            ...
            mvPT = myAvatar.pMC.simulateTo(Math.round(targetX), Math.round(targetY), speed);
            keyboardMoveLastRetarget = now;

            if ((mvPT == null) || (Point.distance(new Point(myAvatar.pMC.x, myAvatar.pMC.y), mvPT) < 1))
            {
                if (directionChanged)
                {
                    stopKeyboardMovement();
        ...
        {
            if (((myAvatar == null) || (myAvatar.dataLeaf == null) || (myAvatar.pMC == null) || (CHARS == null)))
            {
                return;
            }
            var aura:Object;
        ...
        {
            if (((myAvatar == null) || (myAvatar.pMC == null) || (myAvatar.pMC.shadow == null)))
            {
                return (false);
            }
        ...
        public function pushMove(_arg_1:MovieClip, _arg_2:int, _arg_3:int, _arg_4:int):*
        {
            ...
            if (justRan)
            {
                // Keep the Space/Dash cost at 50 even if a stale character
                // state still contains the legacy $dsh=100 value.
                if (((uoTree[myAvatar.pnm] != null) && (uoTree[myAvatar.pnm].sta != null)))
                {
        ...
        public function updateDatabaseMapArrows():void
        {
            ...
            for each (row in mapArrows)
            {
                ...
                rowFrame = String(("strFrame" in row) ? row.strFrame : (("Frame" in row) ? row.Frame : ""));
                if (rowFrame.toLowerCase() != String(strFrame).toLowerCase())
                {
                    continue;
                }
        ...
        public function updateDatabaseNPCs():void
        {
            ...
            var imageOffsetX:Number;
            var imageOffsetY:Number;
            var imageTurn:String;
            var imageActor:DatabaseNPCImage;
            ...
            for each (row in npcmap)
            {
                ...
                if (!(("strFrame" in row)) && ("Frame" in row) && (String(row.Frame) != strFrame))
                {
                    continue;
                }
                ...
                leaf.entID = uid;
                leaf.entType = "n";
                leaf.strFrame = (("strFrame" in row) ? String(row.strFrame) : (("Frame" in row) ? String(row.Frame) : strFrame));
                leaf.strPad = "none";
                ...
                // Static-image NPC support. The emulator sends both strImage and
                // Image for compatibility; either may be present on older/newer
                // Aera builds. Blank keeps the normal equipment-driven avatar.
                imagePath = databaseNPCString(row, ["strImage", "Image", "image"], "");
                imageScale = databaseNPCNumber(row, ["ImageScale", "imageScale"], 1);
                imageOffsetX = databaseNPCNumber(row, ["ImageOffsetX", "imageOffsetX"], 0);
                imageOffsetY = databaseNPCNumber(row, ["ImageOffsetY", "imageOffsetY"], 0);
                imageTurn = databaseNPCTurn(row);
                data.dbImage = imagePath;
                data.dbImageScale = imageScale;
                data.dbImageOffsetX = imageOffsetX;
                data.dbImageOffsetY = imageOffsetY;
                ...
                if (imagePath != "")
                {
                    try
                    {
                        // Keep the AvatarMC shell/nameplate so the image NPC still
                        // participates in z-sorting and the existing NPC interaction
                        // system, but replace the visible skeleton with the PNG/JPG.
                        mc.mcChar.visible = false;
                        mc.mcChar.mouseEnabled = false;
                        mc.shadow.visible = false;
                        mc.shadow.mouseEnabled = false;
                        mc.cShadow.visible = false;

                        imageActor = new DatabaseNPCImage(
                            this,
                            avt,
                            resolveDatabaseNPCImageURL(imagePath),
                            imageScale,
                            imageOffsetX,
                            imageOffsetY,
                            imageTurn
                        );
                        imageActor.name = "dbNpcImage";

                        // Put the image under the NPC name/job text, not over it.
                        try
                        {
                            mc.addChildAt(imageActor, mc.getChildIndex(mc.pname));
                        }
                        catch(addImageError:Error)
                        {
                            mc.addChild(imageActor);
                        }
                    }
                    catch(imageError:Error)
                    {
                        trace("Database NPC image setup error: " + imageError.message);
                    }
                }
            }
        ...
        private function databaseNPCString(row:Object, fields:Array, fallback:String=""):String
        {
            var field:String;
            var value:*;
            if (row == null)
        ...
        private function databaseNPCNumber(row:Object, fields:Array, fallback:Number=0):Number
        {
            var text:String = databaseNPCString(row, fields, "");
            var value:Number;
            if (text == "")
            {
                return fallback;
        ...
        private function databaseNPCTurn(row:Object):String
        {
            var value:String = databaseNPCString(row, ["strTurn", "Turn", "turn"], "Right").toLowerCase();
            if (value == "left")
            {
                return "left";
            }
        ...
        private function resolveDatabaseNPCImageURL(imagePath:String):String
        {
            ...
            // Admin NPC uploads are stored as paths such as
            // npcs/My-NPC.png under public/gamefiles/.
        ...
        private function databaseNPCPanelIsOpen():Boolean
        {
            ...
            try
            {
                if (((rootClass != null) && (rootClass.ui != null) && (rootClass.ui.ModalStack != null)))
                {
                    ...
                    {
                        if (container.getChildAt(i) is npcPanel)
                        {
                            return true;
                        }
                        i++;
        ...
        public function closeDatabaseNPCPanel():Boolean
        {
            ...
            try
            {
                ...
                while (i >= 0)
                {
                    if (container.getChildAt(i) is npcPanel)
                    {
                        panel = (container.getChildAt(i) as npcPanel);
                        panel.close();
                        return true;
                    }
                    i--;
        ...
        public function executeDatabaseNPCButton(button:Object, avt:Avatar):void
        {
            ...
            {
                case "shop":
                    // Shops use their own UI layer, so remove the NPC dialog first.
                    // Quest windows already close it through the existing quest flow.
                    closeDatabaseNPCPanel();
...
//            }
        ...
        public function initMonsters(_arg_1:Array, _arg_2:Array):*
        {
            ...
            if (((!(_arg_1 == null)) && (!(_arg_2 == null))))
            {
                ...
                {
                    // Accept both the emulator's legacy AQW protocol field names and
                    // raw Aera maps_monsters column names. Database rows with X/Y are
                    // marked for coordinate spawning so the map SWF needs no MonMapID marker.
                    if (!("MonID" in _arg_2[_local_3]) && ("MonsterID" in _arg_2[_local_3]))
                    {
                        _arg_2[_local_3].MonID = _arg_2[_local_3].MonsterID;
                    }
                    if (!("strFrame" in _arg_2[_local_3]) && ("Frame" in _arg_2[_local_3]))
                    {
                        _arg_2[_local_3].strFrame = String(_arg_2[_local_3].Frame);
                    }
                    if (("X" in _arg_2[_local_3]) && ("Y" in _arg_2[_local_3]) && !("dbSpawn" in _arg_2[_local_3]))
                    {
                        _arg_2[_local_3].dbSpawn = 1;
                    }
        ...
        {
            if (((actionObj == null) || (rootClass == null) || (rootClass.sfc == null) || (myAvatar == null) || (myAvatar.dataLeaf == null) || (myAvatar.pMC == null)))
            {
                return;
            }
            var a:int;
...
//                                    if ((((!(tLeaf == null)) && ((((!(bPvP)) && (tAvt.npcType == "monster")) || (((bPvP) && (tAvt.npcType == "player")) && (!(cLeaf.pvpTeam == tLeaf.pvpTeam)))) || ((((bPvP) && (tAvt.npcType == "monster")) && (!(tLeaf.react == null))) && (tLeaf.react[cLeaf.pvpTeam] == 0)))) && (actionRangeCheck(actionObj, tAvt))))
        ...
        {
            var _local_1:*;
            // Aera: derived-stat packets can arrive before the class action list has
            // finished loading. Treat that state as "no auto attack yet" instead
            // of dereferencing actions.active and crashing with Error #1010.
...
//        }
        ...
        {
            var _local_2:Object;
            if (((_arg_1 == null) || (_arg_1.a == null) || (!(_arg_1.a is Array)) || (_arg_1.a.length < 1)))
            {
                return;
            }
