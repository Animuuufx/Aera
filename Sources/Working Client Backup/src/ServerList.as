...
//            }
        ...
        private function onRefreshCooldown(_arg_1:TimerEvent):void
        {
            ...
            {
                legend.txtRefresh.text = "Refresh";
            }
        }
        ...
        private function onRefreshClick(_arg_1:MouseEvent):*
        {
            ...
            tRefresh.reset();
            tRefresh.start();
            legend.txtRefresh.text = "Refresh (5)";
            ...
            _local_2.addEventListener(IOErrorEvent.IO_ERROR, onServerListError, false, 0, true);
            _local_2.addEventListener(SecurityErrorEvent.SECURITY_ERROR, onServerListSecurityError, false, 0, true);
        ...
        private function onServerListComplete(_arg_1:Event):void
        {
            try
            {
                if (((_arg_1 != null) && (_arg_1.target != null) && (_arg_1.target.data != null) && (String(_arg_1.target.data).indexOf("{notused}") == -1)))
                {
                    var _local_1:Object = com.adobe.serialization.json.JSON.decode(String(_arg_1.target.data));
                    if (_local_1 is Array)
                    {
                        Game.objLogin.servers = _local_1;
                    }
                }
            }
            catch(e:Error)
        ...
        private function onServerListError(_arg_1:IOErrorEvent):void
        {
            rootClass.mcLogin.gotoAndStop("Servers");
        }

        private function onServerListSecurityError(_arg_1:SecurityErrorEvent):void
        {
            rootClass.mcLogin.gotoAndStop("Servers");
        }
