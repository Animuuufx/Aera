...
//                            showPortraitBox(world.myAvatar, ui.mcPortrait);
                        ...
                        case "stu":
                            ...
                            if (avt != null && avt.objData != null)
                            {
                                if (resObj.intHP != null) avt.objData.intHP = int(resObj.intHP);
                                if (resObj.intHPMax != null) avt.objData.intHPMax = int(resObj.intHPMax);
                                if (resObj.intMP != null) avt.objData.intMP = int(resObj.intMP);
                                if (resObj.intMPMax != null) avt.objData.intMPMax = int(resObj.intMPMax);
                                if (resObj.intState != null) avt.objData.intState = int(resObj.intState);
                            }
                            if (resObj.wDPS != null)
                            {
