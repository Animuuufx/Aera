...
package 
{
	...
	<l1 id="z" display="OK." text="OK."/>
        ...
        public function Chat()
        {
            ...
            chn.support.col = "2DD4BF";
            chn.moderator.col = "FFD166";
            chn.admin.col = "FF6B6B";
            chn.administrator.col = "FF6B6B";
            chn.gm.col = "C084FC";
            chn.developer.col = "F59E0B";
            chn.owner.col = "FF4FD8";
        ...
        private function getAeraServerName():String
        {
            ...
            try
            {
                if (((rootClass != null) && (rootClass.objServerInfo != null) && (rootClass.objServerInfo.sName != null)))
                {
                    return (String(rootClass.objServerInfo.sName));
                }
            }
            catch(e2:Error)
            {
        ...
        public function pushMsg(_arg_1:*, _arg_2:*, _arg_3:*, _arg_4:*, _arg_5:*, _arg_6:int=0):*
        {
            ...
            if (isChannel(_arg_1))
            {
                if (((!(_aeraBroadcast)) && (_arg_1 == "zone" || _arg_1 == "world" || _arg_1 == "support" || _arg_1 == "moderator" || _arg_1 == "admin" || _arg_1 == "administrator" || _arg_1 == "gm" || _arg_1 == "developer" || _arg_1 == "owner")))
                {
                ...
                checkFieldsVPos();
                chatArray.push([_arg_1, _arg_2, _arg_3, _arg_4, _arg_5, msgID, (('<font size="11" style="font-family:Arial;">' + format_time()) + "</font> "), _aeraBroadcast]);
                msgID++;
                ...
                while (_local_15 < chatArray.length)
                {
                    ...
                    {
                        _local_28 = (((((_local_8 + "user,") + _local_27) + _local_9) + ((Boolean(chatArray[_local_15][7])) ? " (SERVER)" : "")) + ": ");
                    }
                    if (_local_18 == "SERVER")
                    {
                        _local_28 = "";
            ...
            if (_local_7)
            {
                ...
                _local_29 = (_local_29 + "<br/><a href='event:link::https://nightvaults.com/'><font color='#66CCFF'><u>Click here</u></font></a> to learn more.");
